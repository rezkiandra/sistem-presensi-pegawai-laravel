        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="javascript:void(0)" class="flex ml-2 md:mr-24">
                    ...
                    <span
                        class="self-center text-lg font-semibold sm:text-xl md:text-sm lg:text-xl whitespace-nowrap uppercase dark:text-gray-100">Admin
                        - @yield('title')</span>
                </a>
            </div>
            <div class="flex items-center">
                ...
                <div class="flex items-center ml-2 uppercase text-gray-900 dark:text-gray-100 font-medium">
                    {{ Auth::user()->name }}
                </div>
            </div>
        </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ url('admin/pegawai') }}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Pegawai</span>
                </a>
            </li>
            <li>
